  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="text-center mb-10">
        <div className="inline-block w-40 h-6 bg-slate-200 rounded-full animate-pulse mb-4"></div>
        <div className="w-72 h-10 bg-slate-200 rounded-xl animate-pulse mx-auto mb-3"></div>
        <div className="w-96 h-5 bg-slate-100 rounded-lg animate-pulse mx-auto"></div>
      </div>
          ...
          >
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex justify-between items-end">
                <div>
                  <div className="h-5 bg-slate-200 rounded animate-pulse w-24 mb-1"></div>
